...
# У меня вопрос по домашнему заданию. НИЖЕ Я попробовал оптимизировать код из прошлой темы с
# помощью функции. Но у меня код работает не совсем правильно.
# Именно: 1) не суммируется количество правильных ответов; 2) при вводе неправильного в
# выводится правильный ответ.
# Прошу подсказать как это можно исправить.
